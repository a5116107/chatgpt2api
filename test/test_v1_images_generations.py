...
BASE_URL = os.getenv("CHATGPT2API_LIVE_BASE_URL", "http://localhost:8000").rstrip("/")
RUN_LIVE_TESTS = os.getenv("CHATGPT2API_RUN_LIVE_TESTS", "").strip().lower() in {"1", "true", "yes", "on"}


@unittest.skipUnless(RUN_LIVE_TESTS, "live image smoke tests require CHATGPT2API_RUN_LIVE_TESTS=1")
